...
class FoodListController: UITableViewController {
    ...
    func initFoodList(){
        foodList.append(food(foodName: "cake", foodDescription: "sweet", foodAvatar: nil))
        foodList.append(food(foodName: "apple", foodDescription: "sweet", foodAvatar: nil))
        foodList.append(food(foodName: "banana", foodDescription: "sweet", foodAvatar: nil))
    }
