...
class TodoListTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if let todoListFromFile = loadTodoList() as? [todoItem] {
            ...
            todoList.append(todoItem(title: "Say Hello", itemDescription: "say hello to tomorrow"))
            todoList.append(todoItem(title: "Say Goodbye", itemDescription: "say goodbye to yesterday"))
        }
    }
